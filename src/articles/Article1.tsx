...
import image1 from '../image/articles/article1.jpg';
import ProtectedPage from "../components/ProtectedPage";
import { hashPassword } from "../utils/passwordUtils";
import ArticleImageLayout from "../components/ArticleImageLayout";
import '../style.css';
...
function Article1(props: {
    ...
    setActiveNav: Dispatch<SetStateAction<number>>,
      ...
      const images1 = [image1]; // 1개 이미지
      const images2 = [image1, image1]; // 2개 이미지
      const images3 = [image1, image1, image1]; // 3개 이미지
      ...
      return (
        <ProtectedPage password={hashedPassword}>
          ...
          <div style={{paddingBottom:'200px'}} className='articleLayout'>
            ...
            <ArticleImageLayout images={images1} />
            ...
            <ArticleImageLayout images={images2} />
            ...
            description={<div>
              ...
              <ArticleImageLayout images={images3} />
