  ...
  setActiveNav: Dispatch<SetStateAction<number>>,
    ...
    return (
      ...
      <div className='workContentslist'>
        ...
        <div className='contents zoomIn'>
           <Content projectPage={"Work5"} thumbnail={thumbnail5} projectTitle={'New Service Design'} projectDescription={'Designing an entirely new book-share platform for working people who want to develop compentency.'} projectSubtitle={'Karrot'} period={'2022.01. - 2022.08.'}/>
